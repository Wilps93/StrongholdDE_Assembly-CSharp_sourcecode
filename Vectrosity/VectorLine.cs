...
public class VectorLine
{
	...
	public LineType lineType
	{
		...
		set
		{
			...
			if (value != 0 && ((m_points2 != null && m_points2.Count > 16383) || (m_points3 != null && m_points3.Count > 16383)))
			{
				Resize(16383);
			}
			if (collider)
	...
	public void SetEndCapIndex(EndCap endCap, int index)
	{
		...
		if (endCap != 0 && endCap != EndCap.Back)
		{
	...
	private void DrawEndCap(bool draw3D)
	{
		if (m_capType <= EndCap.Mirror)
		{
			...
			if (m_frontEndCapIndex != -1)
			{
				...
				if (m_lineType == LineType.Discrete && ((uint)num & (true ? 1u : 0u)) != 0)
				{
					num++;
				}
